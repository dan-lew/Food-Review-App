...
const Map=()=>{
	return(
		<GoogleMap 
			defaultZoom={5}
			defaultCenter={{lat:53.6424933,lng:10.0465429}}
		/>
	)
}
...
return (
	...
	<GridItem justify="center" xs={12} sm={12} md={12} lg={12}>
	<div style={{height:"70vh", width:"90vw"}}>
		 
		<WrappedMap
			googleMapURL={`https://maps.googleapis.com/maps/api/?key=${process.env.REACT_API_KEY}`}
...
// 		const placeIdV = place.place_id;
//     console.log( 'placeIdV', placeIdV );
// 	};
 

// 	render(){
//     let latVal = this.state.mapPosition.lat;
